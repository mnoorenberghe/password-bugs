...
function init() {
  ...
  Object.keys(gMetabugs).forEach(function(list){
    ...
    fileBugList.innerHTML += '<li><a href="https://bugzilla.mozilla.org/enter_bug.cgi?product=Toolkit&component=Password%20Manager&blocked=' + gMetabugs[list] + '">' + list + '</a></li>';
...
function getBugsUnderRoot() {
  ...
  document.title = rootBugOrAlias + " - Passwords Bug List";
